...
test "$("$plist_buddy" -c 'Print :CFBundleShortVersionString' "$plist")" = "1.0.0"
...
echo "Verified Statlet.app: version 1.0.0, macOS 14+, arm64, privacy manifest, notices, hardened-runtime signature"
